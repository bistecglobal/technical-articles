---
title: "Browse Before You Install: Building a Public Skill Catalog for a Claude Code Plugin"
project: ai-core
tags: [AI, Claude Code, DevEx, Developer Tools, Plugin Development]
status: audited
date: 2026-06-22
---
...
The manifest doesn't carry a `category` field on most components. Rather than retrofit the manifest schema, the catalog infers categories from existing tags using a local mapping table (`detectCategory()` in `catalog.html`):
