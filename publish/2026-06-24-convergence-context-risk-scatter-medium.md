# Two Numbers, One Verdict: Triaging AI Agents on a Convergence × Context-Risk Scatter

*Context usage and goal progress are both ambiguous alone. Crossed on a scatter plot, they name the one agent about to stall hard.*
