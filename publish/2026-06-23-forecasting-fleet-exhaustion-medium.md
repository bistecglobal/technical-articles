# When Does the Fleet Run Out? Forecasting Token Burn and Backlog Velocity in Mission Control

*A budget alert at 100% is a smoke detector that goes off after the house has burned down. Here's how we built the forward look.*
