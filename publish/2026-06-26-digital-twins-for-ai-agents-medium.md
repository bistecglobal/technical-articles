# Digital Twins for AI Agents: Finding the Project That Behaves Just Like This One

*Reduce each agent to a five-number behavioural fingerprint, then ask: which other agent is it secretly the same as?*
