# Does a Bigger Memory Make a Smarter Agent? A Diagnostic Quadrant for an AI Fleet

*"More memory is better" is an assumption nobody checks. Plot it, and you find the agents carrying dead weight.*
