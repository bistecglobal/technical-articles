# No Slug Required: Per-Channel Native Slash Commands for a Multi-Project AI Fleet

*The channel already knows which project it is. We stopped making operators say it twice.*
