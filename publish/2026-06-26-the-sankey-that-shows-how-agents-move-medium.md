# The Sankey That Shows How Agents Move: Reconstructing Fleet State From Raw Logs

*Your agents' busy/idle/stuck/crashed states are never written down. Here's how we rebuilt them from the log after the fact.*
