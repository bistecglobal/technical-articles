# Watching an AI Fleet Remember: A Silhouette Streamgraph of Memory Growth

*A count tells you how much an agent remembers. It can't tell you how it got there. So we drew the shape.*
