# One Attention Engine, Two Faces: Killing 500 Lines of Duplicated Fleet Logic

*Two features answered the same question in two voices — and gave two different answers. The fix wasn't more logic. It was one copy of it.*
