# When Three Agents Fail at Once: Correlating Tool Errors Across a Fleet

*A single agent's tool error is noise. Three agents failing on the same tool in the same five minutes is an outage — here's how we tell them apart.*
