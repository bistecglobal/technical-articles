# Did the Schedule Actually Fire? Run History for Autonomous Agents

*A scheduled task is a promise made to the future — and the future doesn't send receipts. Here's how we built the receipt for a fleet of autonomous agents.*
