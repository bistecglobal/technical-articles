# Three Caches, One Runner: How We Cut the Repeated Work Out of a Next.js E2E Pipeline

*A slow CI pipeline isn't a speed problem — it's an attention problem. Here's how we stopped doing the same expensive work on every run.*
