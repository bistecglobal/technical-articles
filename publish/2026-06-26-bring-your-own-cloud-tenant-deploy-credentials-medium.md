# Whose Cloud Does It Deploy To? Tenant-Scoped Deploy Credentials Done Carefully

*Adding tenant-owned deploy credentials was the easy 80%. Deciding exactly when NOT to fall back to operator defaults was the security-critical 20%.*
