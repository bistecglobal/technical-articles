# When Will This Agent Actually Finish? Fitting a Trend Line to Goal Convergence

*A score says where an agent is. A slope says where it's going. For anything that runs on its own, the second question is the one worth answering.*
