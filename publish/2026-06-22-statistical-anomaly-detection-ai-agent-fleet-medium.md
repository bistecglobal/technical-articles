...
*How we applied z-score anomaly detection to Claude Code JSONL transcripts to catch runaway, stalled, and spiraling agents across a 19-project autonomous fleet.*
