...
*No new infrastructure required — MCD reads the JSONL files Claude Code already writes and turns them into a ranked fleet performance report.*
...
The feature shipped in MCD PR #96, alongside the Proposal-to-Impact Traceability Matrix (P53), which connects pipeline changes to their git commit counts and line diffs for a complementary view of what agents shipped vs. what they consumed.
