# The Trend Line and the Suspects: Two Views That Make AI Fleet Progress Accountable

*A trend line tells you the fleet slipped. A movers leaderboard tells you who slipped it. Wire both to one table and a dip becomes an address.*
