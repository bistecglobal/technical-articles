# One Tenant, Two IDs: The Identity Bug Hiding in Your Multi-Tenant Guard

*Your cross-tenant security check compared two strings. The problem: the same tenant can arrive spelled two different ways.*
