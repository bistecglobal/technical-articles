# The Average Is Lying to You: Percentile Latency for an AI Agent Fleet

*Why the mean response time of your AI agent fleet hides exactly the problems you need to see — and how percentiles surface them.*
