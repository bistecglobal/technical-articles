...
*How we built two complementary features — templated context injection and git-based memory drift scoring — to keep a fleet of long-running Claude Code agents oriented and auditable.*
