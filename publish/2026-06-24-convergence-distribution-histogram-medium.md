# The Average Hid a Split Fleet: A Convergence Histogram for AI Agents

*A mean of 0.5 can mean "everyone's halfway" or "half are done, half are dead." Only the distribution tells you which.*
